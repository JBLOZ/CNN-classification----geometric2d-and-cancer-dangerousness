function skinCancerResNet50TransferLearning(mode)
    ...
    switch mode
        case 'train'
            ...
            %% Entrenar la red (si aún no existe el modelo)
            if isfile('trainedSkinCancerResNet50.mat')
                fprintf('El modelo entrenado ya existe. Se carga el modelo. Si deseas hacer pruebas usa skinCancerResNet50(`train`)\n');
            ...
            fprintf('Modo TRAIN finalizado. No se realizan pruebas.\n');
    ...
    %% Bloque de test (solo se ejecuta en modo 'test')
    if mode == 'test'
